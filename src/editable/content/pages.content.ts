...
export const pagesContent = {
  home: {
    metadata: {
      title: 'Business articles, listings, and practical discovery',
      description: 'Explore Pokretplus articles, company listings, resources, and professional updates in one polished directory experience.',
      openGraphTitle: 'Business articles, listings, and practical discovery',
      openGraphDescription: 'Discover practical articles and business listings through a clean, professional Pokretplus experience.',
      keywords: ['business articles', 'business listings', 'professional directory', 'company discovery'],
    },
    hero: {
      badge: 'Pokretplus network',
      title: ['Business knowledge,', 'resources, and trusted listings.'],
      description: 'Explore practical articles, compare business listings, and keep useful professional resources close at hand.',
      primaryCta: { label: 'Read articles', href: '/article' },
      secondaryCta: { label: 'Explore listings', href: '/listing' },
      searchPlaceholder: 'Search articles, companies, categories, and resources',
      focusLabel: 'Focus',
  ...
  search: {
    ...
    hero: {
      ...
      title: 'Find articles, businesses, and resources faster.',
      description: 'Use keywords, categories, and content types to explore every active Pokretplus section.',
      placeholder: 'Search by company, topic, category, or title',
    },
