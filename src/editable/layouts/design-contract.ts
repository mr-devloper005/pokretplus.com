...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#172033',
  '--slot4-panel-bg': '#f7f9ff',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#62708a',
  '--slot4-soft-muted-text': '#8a96aa',
  '--slot4-accent': '#ff4f47',
  '--slot4-accent-fill': '#ff4f47',
  '--slot4-accent-soft': '#fff0ed',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#26303c',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#dbe4f3',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#f7f9ff',
  '--slot4-lavender': '#f3f6fc',
  '--slot4-gray': '#f7f9ff',
  '--slot4-body-gradient': 'linear-gradient(180deg,#eef3fb 0%,#ffffff 42%,#f7f9ff 100%)',
  '--editable-page-bg': '#eef3fb',
  '--editable-page-text': '#172033',
  '--editable-container': '1500px',
  '--editable-border': '#dce4f2',
  '--editable-nav-bg': '#ffffff',
  '--editable-nav-text': '#172033',
  '--editable-nav-active': '#ff4f47',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#15184c',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#26303c',
  '--editable-footer-text': '#eef3fb',
} as CSSProperties
