export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'pokretplus',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Pokretplus',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'pokretplus.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://pokretplus.com',
